---
title: '为什么 Checkpoint 没成功，下游却有数据？'
date: '2026-04-03'
...
语义,数据丢失,数据重复,性能开销,典型技术
At-Most-Once,允许,不允许,极低,"UDP, Simple Log"
At-Least-Once,不允许,允许,中等,"Kafka Default, Flume"
Exactly-Once,不允许,不允许,高,Flink + Kafka 2PC
Effectively-Once,不允许,逻辑上不允许,中等,"SQL Upsert, Redis SETNX"
