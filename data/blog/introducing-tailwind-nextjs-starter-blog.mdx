...
1. JS (official support) - `npx degit https://github.com//saxonchen86.git` or TS (community support) - `npx degit timlrx/tailwind-nextjs-starter-blog#typescript`
...
[MIT](https://github.com//saxonchen86/blob/main/LICENSE) © [Timothy Lin](https://www.timrlx.com)
